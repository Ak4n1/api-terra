...
public class CharacterResponseDTO {
    ...
    public void setCurCp(Integer curCp) {
        this.curCp = curCp;
    }
    ...
    public void setCanCraft(Integer canCraft) {
    ...
    public void setCharSlot(Integer charSlot) {
    ...
    public void setWantsPeace(Integer wantsPeace) {
    ...
    public void setSubPledge(Integer subPledge) {
    ...
    public void setBookmarkSlot(Integer bookmarkSlot) {
    ...
    public void setVitalityPoints(Integer vitalityPoints) {
